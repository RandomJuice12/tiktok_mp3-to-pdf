    ...
    <div style={{ background: 'white', borderRadius: '16px', padding: '40px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', maxWidth: '600px', margin: '0 auto' }}>
      ...
      {data && data.music.playUrl && (
        <div style={{ marginTop: '25px', padding: '20px', background: '#f8f9fa', borderRadius: '12px', textAlign: 'center' }}>
          <audio ref={audioRef} controls controlsList="nodownload" src={data.music.playUrl} style={{ width: '100%', height: '50px', borderRadius: '10px' }}>
      ...
      {data && (
        <div style={{ marginTop: '40px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <button onClick={generatePDF} style={{ padding: '16px 36px', background: '#10b981', color: 'white', fontSize: '20px', fontWeight: 'bold', border: 'none', borderRadius: '50px', cursor: 'pointer' }}>
              Download PDF + QR
            </button>
          </div>
        </div>
